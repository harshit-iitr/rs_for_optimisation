...
|---|---|---|---|---|
| [`permuted_mnist/isotropic_control`](permuted_mnist/isotropic_control/STUDY.md) | Is the penalty's retention benefit reproduced by an equal-magnitude, direction-unconstrained intervention? | Paper claim 3 (mechanism: direction vs magnitude). Decisive. | INCOMPLETE (failures present) | 20/40 |
